    ...
    <section id="about" className="container mx-auto p-6">
      <div className="flex flex-col my-12 md:flex-row">
        <div className="flex flex-col md:w-1/2">
          ...
          <button className="bg-thickBrownishYellow w-1/3 text-white mt-5 font-semibold py-2 rounded-full drop-shadow-md hover:bg-brownishYellow focus:outline-none">
            Hire Me
          </button>
        </div>
